...
(function ($) {
    ...
    $.fn.mDatatable = function (options) {
        ...
        var dt = {
                ...
                var afterGetData = function (result) {
                    ...
                    if (options.pagination) {
                        if (options.data.serverPaging && options.data.type !== 'local') {
                            ...
                            var meta = {
                                perpage: dsParams.pagination.perpage,
                                page: API.getCurrentPage(),
                                total: dsParams.total,
                                include: options.include,
                                sort: dsParams.sort.field ? dsParams.sort.field + ' ' + dsParams.sort.sort : null
                            };
            ...
            getData: function () {
                ...
                var ajaxCount = jQuery.extend(true, {}, params)
            ...
            paging: function (meta, callback) {
                ...
                var pg = {
                    ...
                    pager: null,
                    paginateEvent: null,
                    pagerLayout: {pagination: null, info: null, actions: null},
                    callback: null,
                    init: function (meta) {
                        pg.meta = meta;
                    ...
                    populate: function () {
                        ...
                        if(API.getOption('toolbar.items.actions')) {
                            ...
                            $.each(API.getOption('toolbar.items.actions'),
                                function (i, action) {
                                    var display = action.name;
                    ...
                    exeAction: function (e) {
                        var actions = API.getOption('toolbar.items.actions');
                        var action = actions[e.target.value];
                        var selectedIds = [];
                        $('[id^="select-"]:checked').each(function (i, n) {
                            selectedIds.push(n.id.replace('select-', ''))
                        });
                        action.fn(selectedIds)
                        $(e.target).selectpicker('val', null)
                    ...
                    updatePerpage: function (e) {
                        ...
                        $(pg.pager).find('select.m-datatable__pager-size')
                            .val(pg.meta.perpage)
        ...
        var API = {
            ...
            search: function (value, columns) {
                ...
                delay(function () {
                    ...
                    if (typeof columns === 'undefined' && typeof value !== 'undefined') {
                        ...
                        //todo:add seetings for operators
                    } else if (typeof columns === 'undefined' && typeof value === 'undefined') {
                        var key = dt.getGeneralSearchKey();
                        if (query.hasOwnProperty(key))
                            delete  query[key]
                    }
            ...
            getDataSourceParam: function (param) {
                var defaultSort = dt.getDefaultSortColumn();
                datatable.API.params = $.extend({}, {
                    pagination: {page: 1, perpage: API.getPageSize()},
                    sort: {sort: defaultSort.sort, field: defaultSort.field},
                    query: {},
                }, datatable.API.params, dt.stateGet(dt.stateId));
    ...
    $.fn.mDatatable.defaults = {
        ...
        toolbar: {
            ...
            layout: ['actions', 'pagination', 'info'],
