...
var DatatableRemoteAjaxDemo = function () {
    //== Private functions
    var baseUrl = 'http://localhost:3000/api/admin/admin-user-country'
    // basic demo
    var demo = function () {
            ...
            columns: [
...

                {
                    ...
                    template: function (row) {
                        ...
                        return '\
                            <a href="#/admin-users-countries/' + row.id + '" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">\
        ...
        $('#m_form_name').on('change', function () {
            ...
            var query = datatable.getDataSourceQuery();
            query.country_id = $(this).val();
            // shortcode to datatable.setDataSourceParam('query', query);
            datatable.setDataSourceQuery(query);
            datatable.load();
        }).val(typeof query.country_id !== 'undefined' ? query.country_id : '');
