...
var DatatableRemoteAjaxDemo = function () {
    //== Private functions
    var baseUrl = 'http://localhost:3000/api/admin/feature-acl'
    // basic demo
    var demo = function () {
        ...
        var datatable = $('.m_datatable').mDatatable({
            ...
            columns: [
                ...
                {
                    field: 'feature_api_url',
                    title: 'Feature api url',
...

                {
                    ...
                    template: function (row) {
                        ...
                        return '\
                            <a href="#/feature-acls/'+row.id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">\
