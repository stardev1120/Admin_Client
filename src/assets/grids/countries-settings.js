...
var DatatableAettingsRemoteAjaxDemo = function () {
    //== Private functions
    var baseUrl = 'http://localhost:3000/api/admin/country-setting'
    // basic demo
    var demo = function () {
            ...
            columns: [
...

                {
                    ...
                    template: function (row) {
                        ...
                        return '\
                            <a href="#/countries-settings/'+row.id+'" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">\
